...
download_info = Dict(
    Linux(:aarch64, :glibc, :blank_abi) => ("$bin_prefix/Zlib.aarch64-linux-gnu.tar.gz", "f5ad5b4390ddd6d6a96cc573b5b6aadce31977698355658f03a62351f02f8e2d"),
    Linux(:i686, :glibc, :blank_abi) => ("$bin_prefix/Zlib.i686-linux-gnu.tar.gz", "20afcaf2536f43b35814d56bd8a26cd39b068ffe1a513c21dc61d600ef8b4bee"),
    Linux(:x86_64, :glibc, :blank_abi) => ("$bin_prefix/Zlib.x86_64-linux-gnu.tar.gz", "769aee697443ef7111bab843df304f50eedd671006fad9f49913abed0dbac64b"),
    MacOS(:x86_64, :blank_libc, :blank_abi) => ("$bin_prefix/Zlib.x86_64-apple-darwin14.tar.gz", "924f13195b3b95c4d23f3828ecb6ae3b1c8f3a1c4d5372a13090cff4e7ed1c4a"),
    Windows(:i686, :blank_libc, :blank_abi) => ("$bin_prefix/Zlib.i686-w64-mingw32.tar.gz", "1b85dc6e98e7677b63e6cf7ce97718e892cfdd858b7a210b723ce1b5c86e48d7"),
    Windows(:x86_64, :blank_libc, :blank_abi) => ("$bin_prefix/Zlib.x86_64-w64-mingw32.tar.gz", "4479f1b7559227767e305520efe077f575b3edc7cb59235dbdca33e09a756ed1"),
    UnknownPlatform() => ("$bin_prefix/Zlib.arm-linux-gnueabihf.tar.gz", "ea00d81a87aa1159348ae570f17398eb5fb6ffea1c8e97751cb4aa5db2e00acf"),
)
